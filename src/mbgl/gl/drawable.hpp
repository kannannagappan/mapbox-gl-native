...
class Drawable {
public:
    template <class Shader, class Uniforms, class Subject>
    Drawable(Depth depth_,
        ...
        : mode(subject.mode),
          ...
          uniformBindings(UniformBindings<Shader, Uniforms>()(shader, uniforms)),
          attributeBindings(AttributeBindings<Shader, typename Subject::VertexType>()(shader))
    {
        ...
        static_assert(std::is_same<typename Shader::UniformsType, Uniforms>::value, "uniforms type mismatch");
